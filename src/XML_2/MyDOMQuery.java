...
public class MyDOMQuery {
	...
	public static void main(String[] args) {
		try{
			File xmlFile = new File (System.getProperty("user.dir")+"\\src\\XML_2\\sourceFile.xml");
			...
			for (int i = 0; i < nList.getLength(); i++){
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE){
					...
					if (student.getAttribute("no").equalsIgnoreCase(studentNo)){
						...
						System.out.println("      number = " + mobilePhone.getElementsByTagName("number").item(0).getTextContent());
